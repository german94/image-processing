...
La mayoría de las veces vamos a estar usando, sin perdida de generalidad, im\'agenes cuadradas y valores de k, tales que $(anchoDeImagen + k) / (k + 1)$ de como resultado un n\'umero entero. Decidimos esto para no trabajar con casos bordes de acuerdo a la esquematizaci\'on del zoom dada por la catedra.
