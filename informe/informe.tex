...
La mayoría de las veces vamos a estar usando, sin pérdida de generalidad, im\'agenes cuadradas. Además utilizaremos valores de k, tales que $(anchoDeImagen + k) / (k + 1)$ y $(altoDeImagen + k) / (k + 1)$ de como resultado un n\'umero entero. Decidimos esto para no trabajar con casos bordes de acuerdo a la esquematizaci\'on del zoom dada por la cátedra.
...
\bibitem{burden} Burden R. L., Faires J.D.- Numerical Analysis, ninth edition. Pág 145 Algorithm 3.4, Natural Cubic Spline. 
\end{thebibliography}
