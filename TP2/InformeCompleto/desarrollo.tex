...
\subsection{Elección de K, hipótesis}
...
A partir de esta distribución elaboramos una primer hipótesis. 
 Hipótesis1: Para los K de mayor valor, la tasa de reconocimiento promedio es mayor que para los de menor valor.  
