...
\subsection{Elección de K, hipótesis 1}
 ...
 Para las siguientes experimentaciones aplicaremos la técnica de $K-Fold$ $Cross$ $Validation$, para la misma es necesario la elección de un valor K que representa la cantidad de conjuntos en la que dividiremos la base de train. Dado que para la formación de las particiones, que serán utilizadas tanto para test como para train, utilizamos el comando CVPARTITION, el mismo las calcula como:\newline
 
\noindent cantidad de imágenes de test = $n/K$  (1)\newline
