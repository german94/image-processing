...
También podemos ver que al incrementar k se obtiene un tiempo mayor. Esto se debe a que en el algoritmo de knn se debe recorrer un vector de tamaño k donde se encuentran los mas cercanos, para en cada paso actualizarlo. 
